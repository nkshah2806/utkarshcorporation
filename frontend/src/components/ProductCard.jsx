  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <h3 className="font-serif-display text-lg text-[#1A3626] mb-1 line-clamp-2">{product.name}</h3>
        <p className="text-xs text-[#1A3626]/60 line-clamp-2 mb-3 flex-1">{product.short_description}</p>
