...
export default function AdminDashboard() {
  ...
  const reload = async () => {
    const [s, p, o, c, i, cats] = await Promise.all([
      ...
      api.get("/health-camps").then((r) => r.data),
      api.get("/admin/distributor-inquiries").then((r) => r.data),
      api.get("/categories").then((r) => r.data),
    ]);
    setStats(s); setProducts(p); setOrders(o); setCamps(c); setInquiries(i); setCategories(cats);
  };
